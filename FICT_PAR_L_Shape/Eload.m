...
for i=1:3,
 ...
 for i=1:7,
     ...
     PHI(3)=ALAM3;
    for j=1:3,
        %F(j,1)=F(j,1)+PHI(j)*W(i)*(4-((ALAM1*X1+ALAM2*X2+ALAM3*X3-0.5)^2 + (ALAM1*Y1+ALAM2*Y2+ALAM3*Y3-0.5)^2-1/16));
%         F(j,1)=F(j,1)+PHI(j)*W(i)*(-1)*( (6*(ALAM1*X1+ALAM2*X2+ALAM3*X3)-3)* ( (ALAM1*Y1+ALAM2*Y2+ALAM3*Y3)^3-1.5*(ALAM1*Y1+ALAM2*Y2+ALAM3*Y3)^2+0.66*(ALAM1*Y1+ALAM2*Y2+ALAM3*Y3)-0.08)+...
%                                           (6*(ALAM1*Y1+ALAM2*Y2+ALAM3*Y3)-3)* ( (ALAM1*X1+ALAM2*X2+ALAM3*X3)^3-1.5*(ALAM1*X1+ALAM2*X2+ALAM3*X3)^2+0.66*(ALAM1*X1+ALAM2*X2+ALAM3*X3)-0.08) );


F(j,1)=F(j,1)+PHI(j)*W(i)*((-1)*( (6*(ALAM1*X1+ALAM2*X2+ALAM3*X3)-3)* ( (ALAM1*Y1+ALAM2*Y2+ALAM3*Y3)^3-1.5*(ALAM1*Y1+ALAM2*Y2+ALAM3*Y3)^2+0.66*(ALAM1*Y1+ALAM2*Y2+ALAM3*Y3)-0.08)+...
                                          (6*(ALAM1*Y1+ALAM2*Y2+ALAM3*Y3)-3)* ( (ALAM1*X1+ALAM2*X2+ALAM3*X3)^3-1.5*(ALAM1*X1+ALAM2*X2+ALAM3*X3)^2+0.66*(ALAM1*X1+ALAM2*X2+ALAM3*X3)-0.08) )+...
                                          (ALAM1*X1+ALAM2*X2+ALAM3*X3-0.2)*(ALAM1*X1+ALAM2*X2+ALAM3*X3-0.8)*(ALAM1*X1+ALAM2*X2+ALAM3*X3-0.5)*...
