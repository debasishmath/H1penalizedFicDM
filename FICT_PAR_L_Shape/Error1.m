...
ER(IELEM,1)=ER(IELEM,1)+W(i)*(  exp(1)*( (ALAM1*X1+ALAM2*X2+ALAM3*X3-0.2)*(ALAM1*X1+ALAM2*X2+ALAM3*X3-0.8)*(ALAM1*X1+ALAM2*X2+ALAM3*X3-0.5)*...
 ...
 ER1(IELEM,1)=ER1(IELEM,1)+W(i)* ((exp(1)*(3*(ALAM1*X1+ALAM2*X2+ALAM3*X3)^2-3*(ALAM1*X1+ALAM2*X2+ALAM3*X3)+0.66)*...
                                         ((ALAM1*Y1+ALAM2*Y2+ALAM3*Y3)^3-1.5*(ALAM1*Y1+ALAM2*Y2+ALAM3*Y3)^2+0.66*(ALAM1*Y1+ALAM2*Y2+ALAM3*Y3)-0.08)  ...
                                        -(U_h(INTLNODS(1,IELEM))*BTI11 +...
                                            U_h(INTLNODS(2,IELEM))*BTI21 + U_h(INTLNODS(3,IELEM))*(-BTI11-BTI21)))^2+...
                                    (exp(1)*(3*(ALAM1*Y1+ALAM2*Y2+ALAM3*Y3)^2-3*(ALAM1*Y1+ALAM2*Y2+ALAM3*Y3)+0.66)*...
                                 ((ALAM1*X1+ALAM2*X2+ALAM3*X3)^3-1.5*(ALAM1*X1+ALAM2*X2+ALAM3*X3)^2+0.66*(ALAM1*X1+ALAM2*X2+ALAM3*X3)-0.08)  ...
