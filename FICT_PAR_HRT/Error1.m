...
ER1=zeros(size(INTLNODS,2),1); %for  seminorm error
...
ERF=zeros(6,1);
ERF1=zeros(6,1);%for H1 seminorm error
for i=1:3,
     ALAMB(i,1)=1.0/3.0;
 end
 ...
 for i=1:7,
  ...
  ER(IELEM,1)=ER(IELEM,1)+W(i)*( ( exp(1)*-(((ALAM1*X1+ALAM2*X2+ALAM3*X3 -0.5)^2 + (ALAM1*Y1+ALAM2*Y2+ALAM3*Y3- 0.5)^2 -0.0625 )^3-...
 ...
 ER1(IELEM,1)=ER1(IELEM,1)+W(i)* (  (exp(1)*(-6*(ALAM1*X1+ALAM2*X2+ALAM3*X3 -0.5)*( (ALAM1*X1+ALAM2*X2+ALAM3*X3 -0.5)^2+(ALAM1*Y1+ALAM2*Y2+ALAM3*Y3 -0.5)^2-0.0625)^2+...
                                     2*(ALAM1*X1+ALAM2*X2+ALAM3*X3 -0.5)* (ALAM1*Y1+ALAM2*Y2+ALAM3*Y3   -0.5)^3 )  - (U_h(INTLNODS(1,IELEM))*BTI11 +...
                                            U_h(INTLNODS(2,IELEM))*BTI21 + U_h(INTLNODS(3,IELEM))*(-BTI11-BTI21) )  )^2  +...
                                    ( exp(1)*(-6*(ALAM1*Y1+ALAM2*Y2+ALAM3*Y3 -0.5)* ( (ALAM1*X1+ALAM2*X2+ALAM3*X3 -0.5)^2+(ALAM1*Y1+ALAM2*Y2+ALAM3*Y3 -0.5)^2-0.0625)^2+...
                                    3*(ALAM1*X1+ALAM2*X2+ALAM3*X3 -0.5)^2*(ALAM1*Y1+ALAM2*Y2+ALAM3*Y3 -0.5)^2)-...
                                      (U_h(INTLNODS(1,IELEM))*BTI12 +U_h(INTLNODS(2,IELEM))*BTI22 + U_h(INTLNODS(3,IELEM))*(-BTI12-BTI22)  ) )^2);   
